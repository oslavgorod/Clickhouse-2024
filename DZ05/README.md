...
Ошибка возникает из-за того, что в AggregatingMergeTree для вставки данных нужно использовать INSERT SELECT с агрегатными функциями, а не прямое значение.  
